...
class Module(
    ...
    val travelAgent: TravelAgent
)

fun Application.module(config: AppConfig): Module {
    ...
    val travelAgent = KoogTravelAgent(config, executor, async { tools(config) }, userRepository)
